...
/*
		...
		//Optional<Share> share=shareRepository.findById(sharedId);
...
/*	
	@ApiOperation(value = "listFiles", response = Share.class)
	@RequestMapping(value = "/listFiles", method = RequestMethod.GET)
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listFiles(@PathVariable("userId") long userId) {
		ServerResponse<Object> server = new ServerResponse<Object>();
		Map<String, Object> response = new HashMap<String, Object>();
		List<Share> shareData=shareRepository.findByUserId(userId);
		
	  response = server.getSuccessResponse("listFiles-user", shareData);
	  return new ResponseEntity<Map<String, Object>>(response, HttpStatus.OK);
	}
